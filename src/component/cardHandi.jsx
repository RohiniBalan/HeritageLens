...
function CardHandi({id, img, name, description, isFavorite, handleLike }) {
        ...
        <Card.Body>
          ...
          <div className="d-flex  justify-content-between mx-5">
            <FaHeart
              ...
              onClick={handleLike}
            />
            <Button className="card-btn" onClick={()=> navigate(`/handicraft/${id}`)}>Read More</Button>
          </div>
        </Card.Body>
      </Card>
    </div>
